...
<head>
  ...
  <title>Transactions Detail - SEWAIN Admin</title>
...
<aside class="sidebar" id="sidebar">
  <ul class="sidebar-menu">
    ...
    <!-- TRANSACTIONS -->
    <li><a href="data-transactions.html" class="active">
      <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <main class="main-content">
    ...
    <section class="page-section" id="page-txn-detail">
      <button class="btn-back" onclick="showPage('transactions',document.querySelector('[data-page=transactions]'))">
      ...
      <div class="detail-card">
        ...
        <div class="detail-grid">
          <!-- KOLOM KIRI FIELD -->
          <div class="item-col">
            <div class="detail-field"><label>ID Transaction</label><input type="text" value="T0002" readonly></div>
            <div class="detail-field"><label>User</label><input type="text" value="Aprilia Alfa" readonly></div>
            <div class="detail-field"><label>Date</label><input type="text" value="12 Maret 2026, 09:45 AM" readonly></div>
            <div class="detail-field"><label>Wallet</label><input type="text" value="Transfer Bank BCA" readonly></div>
          </div>

          <!-- KOLOM KANAN FIELD -->
          <div class="item-col">
            <div class="detail-field"><label>Owner</label><input type="text" value="Camping Groups Bandung" readonly></div>
            <div class="detail-field"><label>Denda</label><input type="text" value="-" readonly></div>
            <div class="detail-field"><label>Status</label><input type="text" value="Active Rent" readonly></div>
          </div>
        </div>
