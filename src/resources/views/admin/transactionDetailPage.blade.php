        ...
        <div class="detail-header">
            ...
            <div style="flex:1; min-width:0;">
              ...
              <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:16px;">
                ...
                <span class="badge {{ $transaksi->statusBadgeClass() }}">{{ $transaksi->statusLabel() }}</span>
              </div>

        <div class="detail-grid">
          <!-- KOLOM KIRI FIELD -->
          <div class="item-col">
            <div class="detail-field"><label>ID Transaction</label><input type="text" value="#{{ $transaksi->id }}" readonly></div>
          ...
          <div class="receipt-product">
            ...
            <div class="rec-dates">
              ...
              <div class="rec-date-val">
                ...
                <span class="rec-date-val">{{ $transaksi->tanggal_sewa ? $transaksi->tanggal_sewa->translatedFormat('d F Y') : '-' }}</span>
              </div>
              </div>
              <div class="rec-date-item">
              ...
              <div class="rec-date-val">
                ...
                <span class="rec-date-val">{{ $transaksi->tanggal_kembali_rencana ? $transaksi->tanggal_kembali_rencana->translatedFormat('d F Y') : '-' }}</span>
              </div>
              </div>
            </div>
