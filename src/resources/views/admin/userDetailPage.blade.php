...
<nav>
  ...
  <form action="{{ request()->routeIs('admin.users') ? route('admin.users') : (request()->routeIs('admin.transactions') ? route('admin.transactions') : route('admin.items')) }}" method="GET" class="nav-search" style="margin: 0; display: flex; align-items: center;">
