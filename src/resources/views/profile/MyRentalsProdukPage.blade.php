...
<head>
 ...
 <title>Detail Sewa — SEWAIN</title>
     ...
     <div class="dash-content">
       ...
       <p class="dash-section-sub">Detail transaksi penyewaan kamu.</p>
        ...
        <div class="rd-thumb" style="position:relative;">
          <img src="assets/img/katalog/tent.png" alt=""/>
          ...
          <h3>ALLTREK Tenda Camping 1 Bedroom - 1 Guest Room</h3>
        </div>


       <div class="rd-form-grid">
         <div class="rd-field"><label>ID Transaksi</label><div class="rd-value">TRX-20260517-0042</div></div>
         <div class="rd-field"><label>Owner</label><div class="rd-value">Camping Groups Bandung</div></div>
         <div class="rd-field"><label>User</label><div class="rd-value">Aprilia Alfa</div></div>
         <div class="rd-field"><label>Denda</label><div class="rd-value">-</div></div>
         <div class="rd-field"><label>Date</label><div class="rd-value">12 Maret 2015, 09.45 AM</div></div>
         <div class="rd-field"><label>Status</label><div class="rd-value">Active Rent</div></div>
       </div>
        ...
        <div id="reviews-section">
          ...
          <div class="receipt-product">
            <div class="receipt-product-header">
              ...
              <div class="rec-img">
                <img src="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=200&q=80">
              </div>
              <div class="rec-info">
                <div class="rec-product-name">ALLTREK Tenda Camping Tentastic Outdoor 1 Bedroom + 1 Guest Room</div>
                <div class="rec-price">Rp 450.000/hari</div>
              </div>
            ...
            <div class="rec-dates">
              <div class="rec-date-item">
                <div class="rec-date-label">Tanggal Mulai Peyewaan</div>
              <div class="rec-date-val">
                ...
                <span class="rec-date-val">30 Juli 2026</span>
              </div>
              </div>
              <div class="rec-date-item">
              ...
              <div class="rec-date-val">
                ...
                <span class="rec-date-val">1 Agustus 2026</span>
              </div>
              </div>
            </div>
            ...
            <!-- Rows -->
            <div class="rec-rows">
              <div class="rec-row"><span class="lbl">Durasi Sewa</span><span class="val">2 Hari</span></div>
              <div class="rec-row"><span class="lbl">Subtotal</span><span class="val">Rp 900.000</span></div>
              <div class="rec-row"><span class="lbl">Shipping</span><span class="val">Rp 40.000</span></div>
              <div class="rec-row"><span class="lbl">Jaminan</span><span class="val">Rp 450.000</span></div>
              <div class="rec-row total-row"><span class="lbl">Total</span><span class="val">Rp 1.750.000</span></div>
...
const badgeBg = {
  active:    'rgba(67, 140, 250, 0.35)',
  upcoming:  'rgba(235, 245, 48, 0.35)',
  completed: 'rgba(52, 237, 74, 0.35)',
  canceled:  'rgba(248, 50, 32, 0.35)',
  return:    'rgba(250, 164, 67, 0.35)',
};

document.getElementById('statusBadge').textContent = statusLabels[transaksi.status];
document.getElementById('statusBadge').style.background = badgeBg[transaksi.status];
</script>
</body>
