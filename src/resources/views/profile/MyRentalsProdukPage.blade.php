...
<x-profile-layout active="rentals" pageTitle="My Rentals">
    ...
    <div class="welcome-section">
        ...
        <p class="section-subtitle">Detail penyewaan</p>
    </div>
    ...
    <div class="detail-form-grid">
        ...
        <div class="form-group">
            <label>Owner</label>
            <input type="text" value="{{ $barang->user->name ?? '-' }}" readonly>
        </div>
        <div class="form-group">
            <label>User</label>
    ...
    <div class="receipt-card">
        ...
        @if ($trx->status !== 'selesai')
            <div style="margin-top:18px; display:flex; gap:12px;">
                <a href="{{ route('profile.rentals.pengembalian', $trx->id) }}" class="rent-action-btn" style="position:static;">Ajukan Pengembalian</a>
            </div>
        @endif
    </div>
