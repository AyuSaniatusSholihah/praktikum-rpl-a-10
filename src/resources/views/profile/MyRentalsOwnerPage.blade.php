...
<head>
 ...
 <title>My Rentals Owner — SEWAIN</title>
 <link rel="preconnect" href="https://fonts.googleapis.com" />
 <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
 <link href="https://fonts.googleapis.com/css2?family=Georgia&family=Poppins:wght@300;400;500;600;700;800&family=Vidaloka&family=Volkhov:wght@400;700&display=swap" rel="stylesheet" />
 ...
 <link rel="stylesheet" href="/sewain/assets/css/profiledashboard.css" />
   ...
   <div class="dash-panel">
     ...
     <aside class="dash-sidebar">
        ...
        <div class="avatar">
            ...
            <rect width="38" height="38" rx="4" fill="#B2B9B9"/>
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" x="8" y="8">
                <circle cx="11" cy="11" r="10.5" stroke="white"/>
                <circle cx="11.5" cy="11.5" r="9" stroke="white" stroke-linejoin="bevel" stroke-dasharray="0.39 0.39"/>
                <path d="M11 5.74707C11.4183 6.8102 11.9832 7.83 12.6641 8.70508C13.355 9.59315 14.1807 10.3511 15.1094 10.8457C14.1806 11.3403 13.3551 12.0991 12.6641 12.9873C11.9836 13.862 11.4182 14.8807 11 15.9434C10.5818 14.8807 10.0164 13.862 9.33594 12.9873C8.64472 12.0989 7.8187 11.3403 6.88965 10.8457C7.81859 10.3512 8.64478 9.59339 9.33594 8.70508C10.0168 7.83 10.5817 6.8102 11 5.74707Z" stroke="white"/>
            </svg>
            </svg>
        </div>
        <div class="name">Camping Groups<br/>Bandung</div>
        </div>
<nav class="dash-nav">
  ...
  <a href="my-rentals-owner.html"  class="active">
    <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M15 16H17V8H11V16H13V10H15V16ZM1 16V1C1 0.44772 1.44772 0 2 0H16C16.5523 0 17 0.44772 17 1V6H19V16H20V18H0V16H1ZM5 8V10H7V8H5ZM5 12V14H7V12H5ZM5 4V6H7V4H5Z" fill="white"/>
    </svg>
    Rentals Owner
    ...
    Log Out
      ...
      <div class="dash-content">
        ...
        <div class="profile-avatar" style="position:absolute; top:24px; right:32px; z-index:2;">
          <img src="assets/img/katalog/profile-placeholder.jpg" alt="Profile" 
              onerror="this.style.display='none'"/>
        </div>
        <h2 class="dash-section-title">Rentals Owner</h2>
        <p class="dash-section-sub">Barang-barang kamu yang sedang disewa</p>
        <div class="rental-cards-grid" id="activeRentals"></div>

        <!-- ── HISTORY ── -->
        <h2 class="dash-section-title history">Rentals Owner — History</h2>
        <p class="dash-section-sub">Barang-barang kamu yang telah disewa</p>
        <div class="rental-cards-grid" id="historyRentals"></div>
...
const statusLabels = {
    ...
    <div class="rental-card" onclick="location.href='rental-detail.html'">
      ...
      <div class="rental-card-info">
        ...
        <div class="rental-loc">
          ...
          ${item.location || 'Kota Bandung, Indonesia'}
        </div>
        <div class="rental-price">Rp ${item.price.toLocaleString('id-ID')}/hari</div>

        <div class="rental-date-row">
          ${calSvg}
          Tanggal Sewa: ${item.start} s.d ${item.end}
        </div>
        ${item.returnDate ? `
        <div class="rental-date-row">
          ${calSvg}
          Return Item: ${item.returnDate}
        </div>` : (item.status === 'upcoming' || item.status === 'active') ? `
  ...
  const active = [
    {
      ...
      returnDate: '17/06/2026 (06.00 WIB)',
      img: 'assets/img/katalog/tent.png',
  ...
  const upcoming = [
    {
      title: 'Soleil Set 5 Pcs Alat Masak Camping Nesting Aluminium',
      price: 50000,
      start: '20/06/2026',
      end: '25/06/2026',
      returnDate: '25/06/2026 (08.00 WIB)',
      img: 'assets/img/alat masak camp.webp',
      location: 'Kota Bandung, Indonesia',
      status: 'upcoming'
    },
  ];
  ...
  const history = [
    {
      ...
      img: 'assets/img/katalog/audio.jpg',
      location: 'Kota Bandung, Indonesia',
      status: 'completed'
    },
    {
      title: '1 Sunrei Lampu Camping Wraith (Hike and Ride)',
      price: 25000,
      start: '01/02/2026',
      end: '03/02/2026',
      img: 'assets/img/katalog/lanterns.png',
      location: 'Kota Bandung, Indonesia',
      status: 'completed'
    },
    {
      title: 'Toyota Avanza Hitam (Surakarta)',
      price: 1000000,
      start: '20/01/2026',
      end: '22/01/2026',
      img: 'assets/img/products/car.webp',
    ...
    },
    {
      ...
      img: 'assets/img/ip 18b air.webp',
      location: 'Kota Surakarta, Indonesia',
      status: 'canceled'
    },
  ];
  ...
  function renderCards(data, containerId) {
    ...
    if (!data || data.length === 0) {
      el.innerHTML = `<div class="rental-empty" style="grid-column:1/-1;">Tidak ada data.</div>`;
      return;
    }
    el.innerHTML = data.map(buildRentalCard).join('');
  }

  renderCards([...active, ...upcoming], 'activeRentals');
  renderCards(history,  'historyRentals');
...
// Jalankan juga setelah semua gambar load (biar height-nya akurat)
