...
<x-profile-layout active="owner" pageTitle="Rentals Owner">
    ...
    <div class="dash-content-card">
        ...
        <div class="rental-cards-grid">
            @forelse($aktif as $key => $t)
                ...
                <div class="rental-card-wrapper">
                    <a href="{{ route('profile.owner.produk', $t->id) }}" class="rental-card" style="text-decoration:none; display:block;">
            ...
            @empty
                <div style="color:#8da4be; font-size:13px; grid-column:1/-1;">Belum ada barang yang sedang disewa.</div>
            @endforelse
        </div>
        ...
        <div class="rental-cards-grid">
            ...
            @empty
                <div style="color:#8da4be; font-size:13px; grid-column:1/-1;">Belum ada riwayat penyewaan barang.</div>
            @endforelse
        </div>
    </div>
    ...
    function adjustRentalShape() {
        document.querySelectorAll('.rental-card').forEach(card => {
            ...
            card.style.setProperty('--scale-y', cardHeight / 355);
        });
    }
    adjustRentalShape();
