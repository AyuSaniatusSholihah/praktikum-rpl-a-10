...
<x-profile-layout active="rentals" pageTitle="Pengembalian Barang">
    ...
    <div class="dash-content-card" style="position:relative;">
        ...
        <p class="dash-section-sub">Pengembalian Barang</p>
        ...
        <div class="rd-form-grid" style="margin-bottom:24px;">
            ...
            <div class="rd-field"><label>Owner</label><div class="rd-value">{{ optional($trx->barang)->user->name ?? '-' }}</div></div>
        ...
        <div class="return-box">
            <div class="return-box-grid">
                <div>
                    ...
                    <div class="return-box-value" id="liveClock">
                        --
                    ...
                    <script>
                        function updateLiveClock() {
                            ...
                            if (clockEl) {
                                clockEl.childNodes[0].textContent = day + ' ' + month + ' ' + year + ', ' + hour + '.' + min + ' ';
                            }
                        }
                        updateLiveClock();
