...
<head>
 ...
 <title>Pengembalian Selesai — SEWAIN</title>
    ...
    Log Out
     ...
     <div class="dash-content">
       ...
       <div class="rd-form-grid">
         ...
         <div class="rd-field"><label>Tanggal Mulai</label><div class="rd-value">17 May 2026, 09:00 WIB</div></div>
         <div class="rd-field"><label>Tanggal Selesai</label><div class="rd-value">17 Jun 2026, 09:00 WIB</div></div>
         <div class="rd-field"><label>Metode Pembayaran</label><div class="rd-value">Saldo SEWAIN Wallet</div></div>
         <div class="rd-field"><label>Lokasi Pengambilan</label><div class="rd-value">Jl. Ir. H. Juanda No. 50 (Dago), Bandung</div></div>
       </div>
       ...
       <div class="confirmed-box">
         <div class="check">
           <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            ...
            <strong id="returnStatus">MENUNGGU VERIFIKASI OWNER</strong>
            </p>
         <a href="profile.html" class="btn-back">Back to SEWAIN Profile</a>
       </div>
       </div>
     </div>
...
<script>
  const transaksi = { status: 'completed' };  // ← ini yang bikin badge muncul
  ...
  const returnStatus = 'waiting';
  const returnStatusLabels = {
    waiting:  'MENUNGGU VERIFIKASI OWNER',
    approved: 'PENGEMBALIAN DISETUJUI ✓'
  };
  document.getElementById('returnStatus').textContent = returnStatusLabels[returnStatus];
</script>
