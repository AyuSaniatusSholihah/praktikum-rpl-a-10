...
<head>
 ...
 <title>Rentlas Owner — SEWAIN</title>
     ...
     <div class="dash-content">
       ...
       <div class="rental-detail-header">
        <div class="rd-thumb" style="position:relative;">
          <img src="assets/img/katalog/tent.png" alt="" onerror="this.style.display='none'"/>
       ...
       <div class="rd-form-grid">
         <div class="rd-field"><label>ID Transaksi</label><div class="rd-value">T002</div></div>
         ...
         <div class="rd-field"><label>Tanggal Sewa</label><div class="rd-value">03 April 2026, 06.00 AM</div></div>
         <div class="rd-field"><label>Tanggal Pengambilan</label><div class="rd-value">05 April 2026, 06.00 AM</div></div>
       </div>
...
<div class="return-box">
  <div class="return-box-grid">
    ...
    <div>
      ...
      <div class="return-box-value denda">Rp 40.000 (2 Jam Terlambat)</div>
    </div>
  </div>

  <div class="return-box-bottom">
    <div>
      <div class="return-box-field-label">Upload Foto</div>
  ...
  <!-- Tombol di dalam kotak -->
        ...
        <button class="btn-ajukan-return btn-kirim-return">
...
<script>
// Badge status
const transaksi = { status: 'return' };
const statusLabels = { active:'Active Rent', upcoming:'Upcoming Rent', completed:'Completed Rent', canceled:'Canceled Rent', return:'Return Rent' };
const badgeBg = { active:'rgba(67,140,250,0.35)', upcoming:'rgba(235,245,48,0.35)', completed:'rgba(52,237,74,0.35)', canceled:'rgba(248,50,32,0.35)', return:'rgba(250,164,67,0.35)' };
...
// Tombol ACCEPT → ubah status jadi completed
document.querySelector('.btn-kirim-return').addEventListener('click', function() {
  // Nanti dari db: update status transaksi jadi 'completed'
  transaksi.status = 'completed';
  document.getElementById('statusBadge').textContent = statusLabels[transaksi.status];
  document.getElementById('statusBadge').style.background = badgeBg[transaksi.status];
  
  this.textContent = 'ACCEPTED ✓';
  this.style.background = 'rgba(52,237,74,0.6)';
  this.disabled = true;
