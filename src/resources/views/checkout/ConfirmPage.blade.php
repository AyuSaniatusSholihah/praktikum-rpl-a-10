      ...
      <div class="receipt-card">
        ...
        <div class="receipt-product">
          <div class="receipt-product-header">
            ...
            <div class="rec-img">
              <img src="{{ asset('assets/img/tenda altrek.webp') }}" alt="Tenda Camping">
            </div>
            <div class="rec-product-info">
          ...
          <div class="rec-rows">
            ...
            <div class="rec-row"><span class="lbl">Jaminan</span><span class="val">Rp 810.000</span></div>
            <div class="rec-row total-row"><span class="lbl" style="font-weight:700;">Total</span><span class="val">Rp 1.750.000</span></div>
            <div class="rec-row denda"><span class="lbl">#Catatan Denda Pengembalian</span><span class="val">Rp 15.000/jam</span></div>
          </div>
        </div>
