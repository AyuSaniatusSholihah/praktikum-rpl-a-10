        ...
        <div class="item-details-grid">
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <input type="text" name="nama_barang" id="itemName" value="{{ old('nama_barang', $product->nama_barang) }}" required/>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="tel" id="whatsapp" value="{{ old('whatsapp', $product->user->phone_number ?? '') }}"/>
            </div>
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <textarea id="addInfo" class="large">{{ old('addInfo') }}</textarea>
            </div>
