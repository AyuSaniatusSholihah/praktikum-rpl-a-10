...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'Sewain') }}</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="login-card w-full max-w-md p-8 md:p-12">
        ...
        <h2 class="text-2xl font-semibold text-slate-800 mb-2">Create New Password</h2>
        <p class="text-slate-500 mb-8 text-sm">Please enter your new password below.</p>
        ...
        <form action="{{ route('password.update') }}" method="POST">
            ...
            <div class="input-group mb-8">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" class="input-field" placeholder="Repeat your new password" required>
            </div>

            <button type="submit" class="btn-primary shadow-lg shadow-slate-200">Reset Password</button>
        </form>
    </div>
</body>
</html>
