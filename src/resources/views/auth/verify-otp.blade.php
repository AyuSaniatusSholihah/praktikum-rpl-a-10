...
<head>
  ...
  <title>Verify Email — SEWAIN</title>
  ...
  <main>
    <div class="auth-card">
      ...
      <div class="auth-form-side">
        ...
        <h1 class="auth-title" style="text-align:center;">Enter The Confirmation Code</h1>
        <p class="auth-subtitle">We sent a 4-digit code to <strong>{{ $email }}</strong></p>
        ...
        <form action="{{ route('otp.verify.post') }}" method="POST" id="verifyForm">
          @csrf
          <input type="hidden" name="email" value="{{ $email }}">
          <div class="otp-row">
            <input type="text" name="otp[]" class="otp-input" maxlength="1" id="otp1" inputmode="numeric" pattern="[0-9]" required autofocus autocomplete="off" />
            <input type="text" name="otp[]" class="otp-input" maxlength="1" id="otp2" inputmode="numeric" pattern="[0-9]" required autocomplete="off" />
            <input type="text" name="otp[]" class="otp-input" maxlength="1" id="otp3" inputmode="numeric" pattern="[0-9]" required autocomplete="off" />
            <input type="text" name="otp[]" class="otp-input" maxlength="1" id="otp4" inputmode="numeric" pattern="[0-9]" required autocomplete="off" />
          </div>
