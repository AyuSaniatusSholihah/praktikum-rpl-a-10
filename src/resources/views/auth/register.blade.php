...
<head>
    ...
    <title>Create Account - {{ config('app.name', 'Sewain') }}</title>
...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="login-card flex flex-col md:flex-row w-full max-w-6xl overflow-hidden">
        <!-- Sidebar Image -->
        <div class="hidden md:block w-1/2 sidebar-image min-h-[700px]"></div>
            ...
            <form action="{{ route('register.post') }}" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="phone" name="phone" class="input-field" placeholder="Enter phone number">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" class="input-field" placeholder="Confirm password">
                    </div>
                </div>

                <button type="submit" class="btn-primary shadow-lg shadow-slate-200 mb-6">Create Account</button>
                
                <div class="text-center">
                    <p class="text-sm text-slate-500">Already have an account? <a href="{{ route('login') }}" class="link-accent">Login</a></p>
                </div>
            </form>
