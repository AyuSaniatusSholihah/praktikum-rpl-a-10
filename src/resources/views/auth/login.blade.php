...
<head>
  ...
  <title>Sign In — SEWAIN</title>


  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Jomolhari&family=Poppins:wght@300;400;500;600;700&family=Ponomar&family=Vidaloka&family=Volkhov:wght@400;700&display=swap" rel="stylesheet" />
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .auth-field input::placeholder { color: #9D9D9D; }
    ...
    .btn-auth-outline:hover { border-color: #5b7891; color: var(--blue); }
...
<body>
  ...
  <main>
    <div class="auth-card">
      ...
      <!-- Kiri: foto interior sofa — simpan di assets/img/auth-bg.jpg -->
      ...
      <div class="auth-form-side">
        ...
        <form action="{{ route('login.post') }}" method="POST">
          ...
          <a href="{{ route('register') }}" class="btn-auth-outline">Register Now</a>
