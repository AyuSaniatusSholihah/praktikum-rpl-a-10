...
<div class="floating-actions">
 @auth
 <a class="floating-btn" href="{{ Route::has('review-web') ? route('review-web') : '#' }}" title="Beri Ulasan SEWAIN" aria-label="Beri Ulasan SEWAIN" style="background:#3BA55D; text-decoration:none;">
