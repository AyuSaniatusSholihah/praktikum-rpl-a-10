<nav>
  ...
  <div class="nav-right">
    <div class="profile-dropdown" style="position: relative; display: inline-block;">
      <a href="#" aria-label="Account" style="display: flex; align-items: center; color: currentColor;" onclick="const menu = this.nextElementSibling; menu.style.display = menu.style.display === 'none' ? 'block' : 'none'; return false;">
