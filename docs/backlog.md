...
|----|------|----------|----------|
| 1 | Registrasi & Login | Pengguna dapat membuat akun dan masuk ke sistem | Must Have |
| 2 | Penyewaan Barang | Pengguna dapat menyewa barang dengan memilih tanggal dan jumlah | Must Have |
| 3 | Katalog Barang | Pengguna dapat menambahkan dan mengelola barang yang disewakan | Must Have |
| 4 | Profil User | Menampilkan dan mengelola informasi pengguna | Must Have |
| 5 | Pembayaran & Denda | Sistem mendukung pembayaran dan perhitungan denda keterlambatan | Must Have |
| 6 | Verifikasi Admin | Admin dapat memverifikasi transaksi penyewaan | Must Have |
